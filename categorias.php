...
<html lang="en">
  <head>
    ...
    <title>MiTienda - Categorias </title>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="product-option-shop" style="margin-top:0px; margin-left:5%; font-size:18px; font-weight:520;">
                        <a class="add_to_cart_button" href="nuevacategoria.php">Nueva</a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <tr class="cart_item">
                                            <td>
                                                <div class="product-option-shop" style="margin-top:0px; margin-left:5%;">
                                                    <a class="add_to_cart_button" href="modificarcategoria.php?id=<?php echo $row["id"];?>">Modificar</a>
                                                </div>
                                            </td>
